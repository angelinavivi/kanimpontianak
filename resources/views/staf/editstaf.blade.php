                        ...
                        <div class="col-lg-12">
                            <div class="full dis_flex center_text">
                                <div class="profile_contant">
                                        ...
                                        <!--crud data-->
                                        <form method="POST" action="{{route('staf.updatestaf', $staf->id)}}" enctype="multipart/form-data">
                                            ...
                                            <div class="field margin_0">
                                                ...
                                                <button type="submit" class="main_bt" href="{{ route('staf.detailprofil')}}">Simpan</button>
                                                </div>
                                            </div>
                                        </form>
                                </div>
