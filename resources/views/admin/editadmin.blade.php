                                        ...
                                        <form method="POST" action="{{route('admin.updateadmin', $admin->id)}}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="text" class="form-control" name="Jabatan" id="Jabatan" value="{{$admin->Jabatan}}">
                                                    @error('Jabatan')
                                                    <div class="alert alert-warning">{{$message}}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-8">
                                                    ...
                                                    <select name="Agama" id="Agama" class="form-select">
                                                        ...
                                                        <option value="Protestan" {{$admin->Agama == 'Protestan' ? 'selected' : '' }}>Protestan</option>
                                                        ...
                                                        <option value="Buddha" {{$admin->Agama == 'Buddha' ? 'selected' : '' }}>Buddha</option>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="file" class="form-control" name="profil" id="profil" value="{{$admin->profil}}">
                                                    @if($admin->profil)
                                                    <img src="{{ asset('storage/profil/' . $admin->profil) }}" alt="Foto Paspor" width="100">
                                                    @endif
                                                    @error('profil')
                                                    <div class="alert alert-warning">{{$message}}</div>
                                                    @enderror
